...
function kale_example_sidebar(){
    ...
    the_widget('WP_Widget_Recent_Posts', 'title=' . esc_html__('Viewed Products', 'kale') , 'before_title=<h3 class="widget-title"><span>&after_title=</span></h3>&before_widget=<div class="default-widget widget">&after_widget=</div>');
    echo '</div>';
}
