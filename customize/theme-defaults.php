...
$kale_defaults['kale_footer_copyright']                 = esc_html__('Copyright &copy; ', 'kale'). date('Y') .' Green Natural Oils';
$kale_defaults['kale_nav_search_icon']                  = 1;
$kale_defaults['kale_example_content']					= 1;
$kale_defaults['kale_dropdown_node_enable']             = 0;

$kale_defaults['kale_image_logo_show']                  = 1;
...
$kale_defaults['kale_frontpage_featured_posts_heading'] = esc_html__('Featured Products', 'kale');
...
$kale_defaults['kale_blog_feed_date_show']              = 0;
$kale_defaults['kale_blog_feed_category_show']          = 0;
$kale_defaults['kale_blog_feed_author_show']            = 0;
$kale_defaults['kale_blog_feed_comments_show']          = 0;
$kale_defaults['kale_blog_feed_post_format']            = 'Small';
$kale_defaults['kale_blog_feed_label']                  = __('Recent Posts', 'kale');

$kale_defaults['kale_posts_meta_show']                  = true;
$kale_defaults['kale_posts_date_show']                  = 0;
$kale_defaults['kale_posts_category_show']              = 0;
$kale_defaults['kale_posts_author_show']                = 0;
